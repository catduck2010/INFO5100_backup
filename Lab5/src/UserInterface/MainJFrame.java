...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private void loginJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginJButtonActionPerformed
        ...
        //char[] pswdChars=passwordField.getPassword();
        ...
        for (Organization oz
            ...
            userAccount = oz.getUserAccountDirectory().authenticateUser(
                    username, pswd);
            if (userAccount != null) {
                CardLayout lyot = (CardLayout) container.getLayout();
                SuccessScreen ss = new SuccessScreen(userAccount);
                container.add("SuccessScreen", ss);
                lyot.next(container);
                flag = true;
                break;
            }
